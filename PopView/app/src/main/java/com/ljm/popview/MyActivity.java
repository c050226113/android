...
public class MyActivity extends Activity{
    ...
    private void initPopWindow(View v) {
        View view = LayoutInflater.from(_Context).inflate(R.layout.item_popip, null, false);
        ...
        btn_xixi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MyActivity.this, "你点击了嘻嘻~", Toast.LENGTH_SHORT).show();
            }
        });
        btn_hehe.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MyActivity.this, "你点击了呵呵~", Toast.LENGTH_SHORT).show();
//                popWindow.dismiss();
            }
        });
    }
