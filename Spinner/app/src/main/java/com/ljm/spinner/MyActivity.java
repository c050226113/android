...
import com.ljm.spinner.Model.Hero;
...
public class MyActivity extends Activity implements AdapterView.OnItemSelectedListener{
    ...
    private void bindViews() {
        ...
        mData.add(new Hero(R.drawable.ic_launcher,"迅捷斥候：提莫（Teemo）"));
        mData.add(new Hero(R.drawable.ic_launcher,"诺克萨斯之手：德莱厄斯（Darius）"));
        mData.add(new Hero(R.drawable.ic_launcher,"无极剑圣：易（Yi）"));
        mData.add(new Hero(R.drawable.ic_launcher,"德莱厄斯：德莱文（Draven）"));
        mData.add(new Hero(R.drawable.ic_launcher,"德邦总管：赵信（XinZhao）"));
        mData.add(new Hero(R.drawable.ic_launcher,"狂战士：奥拉夫（Olaf）"));
