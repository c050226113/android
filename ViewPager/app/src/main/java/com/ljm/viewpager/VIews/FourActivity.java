 ...
 */
public class FourActivity extends Activity implements View.OnClickListener ,ViewPager.OnPageChangeListener {
    ...
    private void initViews() {
        ...
        //下划线动画的相关设置：
        bmpWidth = BitmapFactory.decodeResource(getResources(), R.drawable.ic_launcher).getWidth();// 获取图片宽度
        ...
        two = screenW / 3 * 2;// 移动两页的偏移量,比如1直接跳3
        ...
        vpager_four.setAdapter(new MyPageAdapter(listViews));
